...
import {Keyboard, Dimensions, View, Text, TextInput, StyleSheet, TouchableOpacity } from "react-native"
...
export default InstantDelivery=({route})=>{

    // const [pickupLocation, setPickupLocation] = useState()
    const [proceed, setProceed] = useState(true)
   const {deliveryMedium, deliveryType} = route.params
  //  console.log('----', deliveryMedium, deliveryType)
