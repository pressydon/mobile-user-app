...
export default InstantDeliveryDriverWaiting=()=>{
    ...
    return(
      ...
      <View style={{height:'67%'}}>
        ...
        <View style={{padding:20, backgroundColor:'black', borderTopLeftRadius:30, borderTopRightRadius:30}}>
         ...
         <Text style={{color:'gray', textAlign:'center',fontSize:16}}>Your Delivery Agent is waiting</Text>
         <Text style={{color:'white', textAlign:'center',fontSize:30, padding:20}}>03:00</Text>
         <Text style={{color:'gray', textAlign:'center',fontSize:16}}>Price might increase if waiting time elapses</Text>
