...
import { Image, Text, TouchableOpacity, View, Modal, Linking } from "react-native"
import { useNavigation } from "@react-navigation/native";
import { Avatar, Badge, Icon, withBadge } from 'react-native-elements'



export default InstantDeliveryArrived=()=>{
    ...
    return(
      ...
      <View style={{height:'67%'}}>
        ...
        // onPress={() => navigation.goBack(null)}
         ...
         <Text style={{color:'gray', textAlign:'center',fontSize:16}}>Your Delivery Agent has arrived</Text>
